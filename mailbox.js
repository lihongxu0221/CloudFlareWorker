...
/**
 * 共享邮箱模块：供主 Worker（直连回退）与中继 Worker（relay.worker.js）复用。
 * 所有 IMAP/POP3 连接与 MIME 解析逻辑集中在此，凭据与主机一律来自传入的 `env`。
 *
...
/**
 * 双通道删除：POP3 DELE + 强制 QUIT 提交；IMAP STORE+EXPUNGE 真正删除。
...
export { fetchMessages, deleteMessages };
